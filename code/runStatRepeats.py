...
subprocess.run(["./StatRepeats", "preprocessed6.fasta", "6", "-loa", "direct72.fasta", "-dn", "-protein"])
...
subprocess.run(["./StatRepeats", "preprocessed6.fasta", "6", "-loa", "indirect72.fasta", "-in", "-protein"])
